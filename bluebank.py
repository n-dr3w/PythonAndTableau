...
c = 1000
if b > a and b < c:
    print('b is greater than a, but less then c')
...
#another condition different metrecis
a = 40
b = 500
c = 30
if b > a and b < c:
...
c = 30
if b > a or b < c:
    print('b is greater than a or less then c')
else:
    print('no conditions met')
...
purposecount.plot.bar(color = 'purple', width = 0.8)
plt.show()
